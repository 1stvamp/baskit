...
### Using Git submodules
    ...
    cd ..
    git add baskit
    git commit -m 'Switched to baskit 1.0.3'
...
### Using the Debian/Ubuntu package
    ...
    curl -C - -O https://github.com/isotoma/baskit/downloads/baskit-1.0.3-1_all.deb
    sudo dpkg -i baskit-1.0.3-1_all.deb

### Using the Fedora/Redhat/CentOS package

    curl -C - -O https://github.com/isotoma/baskit/downloads/baskit-1.0.3.noarch.rpm
